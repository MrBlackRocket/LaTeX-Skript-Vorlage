...
% Fieldset Box 
% Verwendung \begin{fameexercise}{<TITEL>}<INHALT>\end{fameexercise}
\tikzstyle{titregris} =
...
\newenvironment{fameexercise}[1]% 
   {\begin{mdframed}[style=exercisestyle,theexercisetitle={#1}]}% 
   {\end{mdframed}}% 
\SetBlockEnvironment{fameexercise}
...
\newenvironment{infobox}% 
   {\begin{mdframed}[style=infobox,frametitle={{\Large \Info \hspace{0.3em} Hinweis} \vspace{1em}}]}% 
   {\end{mdframed}}% 
...
\newenvironment{wichtigbox}% 
   {\begin{mdframed}[style=wichtigbox,frametitle={\textcolor{red}{{\Large \Lightning \hspace{0.3em} Wichtig}} \vspace{0.5em}}] }% 
   {\end{mdframed}}% 
